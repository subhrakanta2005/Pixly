  ...
  return (
    <div style={styles.overlay}>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.divider}><span style={{ background: "var(--surface)", padding: "0 12px", position: "relative", top: -1 }}>or</span></div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.field}>
            ...
            <PasswordInput value={password} onChange={(e) => setPassword(e.target.value)} placeholder="Min. 6 characters" autoComplete="new-password" style={styles.input} />
          </div>
...
const styles = {
  overlay: { display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "var(--bg)", padding: "1rem", position: "relative" },
  backBtn: { position: "absolute", top: 24, left: 24, background: "none", border: "none", cursor: "pointer", fontSize: 14, fontWeight: 600, color: "var(--text-secondary)", display: "flex", alignItems: "center", gap: 6 },
  ...
  googleBtn: { width: "100%", display: "flex", alignItems: "center", justifyContent: "center", padding: "12px", border: "1.5px solid var(--border-strong)", borderRadius: 10, background: "var(--surface)", cursor: "pointer", fontSize: 15, fontWeight: 600, color: "var(--text-primary)", marginBottom: "1.5rem" },
  divider: { textAlign: "center", color: "var(--text-muted)", fontSize: 13, marginBottom: "1.5rem", borderTop: "1px solid var(--border)", lineHeight: 0 },
  ...
  terms: { fontSize: 12, color: "var(--text-muted)", textAlign: "center", marginTop: "1rem" },
  switch: { textAlign: "center", fontSize: 14, color: "var(--text-muted)", marginTop: "0.75rem" },
