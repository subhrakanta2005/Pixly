        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={styles.field}>
            <div style={styles.labelRow}>
              ...
              {onForgotPassword && <span onClick={onForgotPassword} style={styles.forgotLink}>Forgot password?</span>}
            </div>
            <PasswordInput value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" autoComplete="current-password" style={styles.input} />
          </div>
...
const styles = {
  ...
  divider: { textAlign: "center", color: "var(--text-muted)", fontSize: 13, marginBottom: "1.5rem", position: "relative", borderTop: "1px solid var(--border)", lineHeight: 0 },
  field: { marginBottom: "1rem" },
  label: { display: "block", fontSize: 13, fontWeight: 600, color: "var(--text-secondary)", marginBottom: 6 },
  labelRow: { display: "flex", alignItems: "center", justifyContent: "space-between" },
  forgotLink: { fontSize: 13, fontWeight: 600, color: "var(--brand)", cursor: "pointer", marginBottom: 6 },
