...
function AppInner() {
  ...
  if (currentTool?.clientOnly) return <ColorPickerPage tool={currentTool} onBack={() => setCurrentTool(null)} />;
  if (currentTool?.customPage === "resize") return <ResizePage tool={currentTool} onBack={() => setCurrentTool(null)} />;
