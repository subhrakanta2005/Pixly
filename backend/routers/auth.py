...
# Per-worker in-process rate limiter — fine for a single Render web service;
# swap the storage_uri for shared Redis if you scale to multiple instances.
...
async def forgot_password(request: Request, body: ForgotPasswordRequest):
    ...
    await send_email(
        ...
        subject="Reset your Pixly password",
        html_content=f"""
            <p>Hi {user.get('name', '')},</p>
            <p>We received a request to reset your Pixly password. This link
