...
class Settings:
    ...
    MONGODB_DB: str = os.getenv("MONGODB_DB", "pixly")
    ...
    BREVO_SENDER_NAME: str = os.getenv("BREVO_SENDER_NAME", "Pixly")
    ...
    # Background removal / upscale models are large; cache them outside /tmp
    # so they survive between requests instead of re-downloading each time.
    MODEL_CACHE_DIR: str = os.getenv("MODEL_CACHE_DIR", "/tmp/pixly-models")
